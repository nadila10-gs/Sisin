/*
  ...
  Fitur: PID Control + TPO + Moving Average + LCD + Button Setpoint
*/
...
double pid_input    = 0;
double pid_output   = 0;
double pid_setpoint = 70.0;

// Nilai tuning PID hasil prediksi
double Kp = 50.005;
double Ki = 0.050;
double Kd = 0.010;
...
const unsigned long TPO_PERIOD     = 2000; // ms
